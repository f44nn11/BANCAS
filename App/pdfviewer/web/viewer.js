...
var date = new Date()
var strurl = currentLocation.substr(1);
var urla = atob(strurl);

var urls = urla.replace("file:", "");
var filenm = urls.split('&')[0] +"_"+date.getTime()+".pdf";
//var api = currentLocation.substr(currentLocation.indexOf("api=") + 4);
//var urlsa = currentLocation.substr(currentLocation.indexOf("api="));
//urls = urls.replace(urlsa, "");

//console.log(urls);
//var DEFAULT_URL = 'http://localhost/ReportServer?/ReportWeb/Report1&rs:Command=Render&rs:ClearSession=true&rv:Toolbar=false&rc:Toolbar=false&rs:format=PDF';
//if (xx == api) {
//    var DEFAULT_URL = 'http://localhost/ReportServer?/ReportWeb/' + urls + 'rs:Command=Render&rs:ClearSession=true&rv:Toolbar=false&rc:Toolbar=false&rs:format=PDF';
//}
var DEFAULT_URL = 'http://localhost/ReportServer?/ReportWeb/' + urls + 'rs:Command=Render&rs:ClearSession=true&rv:Toolbar=false&rc:Toolbar=false&rs:format=PDF';
var pdfjsWebLibs;
{
 ...
 (function () {
  ...
  (function (root, factory) {
   ...
   function getPDFFileNameFromURL(url) {
    ...
    return suggestedFilename || filenm;
   }
    ...
    open: function pdfViewOpen(file, args) {
     ...
     return loadingTask.promise.then(function getDocumentCallback(pdfDocument) {
      ...
      var moreInfo = { message: message };
         //self.error(loadingErrorMessage, moreInfo); //supaya path report tidak keliatan
      self.error(loadingErrorMessage, "");
