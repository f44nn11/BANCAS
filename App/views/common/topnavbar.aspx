<%@ Page Language="VB" AutoEventWireup="false" CodeFile="topnavbar.aspx.vb" Inherits="App_Views_common_topnavbar" %>
...
<div class="row border-bottom">
    <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
        ...
        <ul class="nav navbar-top-links navbar-right">
            <li>
                <span class="m-r-sm text-muted welcome-message">Welcome to WebApplication</span>
            </li>
