...
function appmainControllers($scope, $location, $timeout, localStorageService, authService, appmenuService) {
    $scope.authentication = authService.authentication;
    $scope.SiteMenu = [{
        ID: "",
        NAME: "",
    ...
    //var dataMenu = localStorageService.get('authorizationMenu');
    //$scope.SiteMenu = dataMenu;
...
angular
    ...
    .controller('appmainControllers', appmainControllers)
...
//    return {
//        restrict: 'A',
//        templateUrl: './app/views/menu.aspx'
//    }
//});
//app.directive('headerMain', function () {
//    return {
//        restrict: 'A',
//        templateUrl: './app/views/header.aspx'
//    }
//});
...
//    return {
//        restrict: 'A',
//        templateUrl: './app/views/footer.aspx'
//    }
//});
